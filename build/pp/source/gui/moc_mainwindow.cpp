...
void Manta::MainWnd::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWnd::painterEvent)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWnd::wakeMain)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWnd::setBackgroundMesh)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (MainWnd::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWnd::killMain)) {
                *result = 4;
                return;
            }
        }
        {
            typedef void (MainWnd::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainWnd::exitApp)) {
                *result = 5;
                return;
            }
        }
...
const QMetaObject Manta::MainWnd::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Manta__MainWnd.data,
      qt_meta_data_Manta__MainWnd,  qt_static_metacall, nullptr, nullptr}
};
