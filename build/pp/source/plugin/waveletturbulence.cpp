...
void setObsFromLevelset(FlagGrid& target, LevelsetGrid& levelset, Real threshold = 1.0, int flagv = 2) {
	FOR_IDX(target) {
...
} static PyObject* _W_12 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); FluidSolver *parent = _args.obtainParent(); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(parent, "setObsFromLevelset" , !noTiming ); PyObject *_retval = 0; { ArgLocker _lock; FlagGrid& target = *_args.getPtr<FlagGrid >("target",0,&_lock); LevelsetGrid& levelset = *_args.getPtr<LevelsetGrid >("levelset",1,&_lock); Real threshold = _args.getOpt<Real >("threshold",2,1.0,&_lock); int flagv = _args.getOpt<int >("flagv",3,2,&_lock);   _retval = getPyNone(); setObsFromLevelset(target,levelset,threshold,flagv);  _args.check(); } pbFinalizePlugin(parent,"setObsFromLevelset", !noTiming ); return _retval; } catch(std::exception& e) { pbSetError("setObsFromLevelset",e.what()); return 0; } } static const Pb::Register _RP_setObsFromLevelset ("","setObsFromLevelset",_W_12);  extern "C" { void PbRegister_setObsFromLevelset() { KEEP_UNUSED(_RP_setObsFromLevelset); } } 
void clampRealGridFromLevelset(Grid<Real>& target, LevelsetGrid& levelset, Real threshold = 1.5, Real v = 0.0) {
...
} static PyObject* _W_13 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); FluidSolver *parent = _args.obtainParent(); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(parent, "clampRealGridFromLevelset" , !noTiming ); PyObject *_retval = 0; { ArgLocker _lock; Grid<Real>& target = *_args.getPtr<Grid<Real> >("target",0,&_lock); LevelsetGrid& levelset = *_args.getPtr<LevelsetGrid >("levelset",1,&_lock); Real threshold = _args.getOpt<Real >("threshold",2,1.5,&_lock); Real v = _args.getOpt<Real >("v",3,0.0,&_lock);   _retval = getPyNone(); clampRealGridFromLevelset(target,levelset,threshold,v);  _args.check(); } pbFinalizePlugin(parent,"clampRealGridFromLevelset", !noTiming ); return _retval; } catch(std::exception& e) { pbSetError("clampRealGridFromLevelset",e.what()); return 0; } } static const Pb::Register _RP_clampRealGridFromLevelset ("","clampRealGridFromLevelset",_W_13);  extern "C" { void PbRegister_clampRealGridFromLevelset() { KEEP_UNUSED(_RP_clampRealGridFromLevelset); } } 
