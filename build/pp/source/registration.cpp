extern "C" {
		...
		extern void PbRegister_setObsFromLevelset() ;
		extern void PbRegister_clampRealGridFromLevelset() ;
		...
		extern void PbRegister_centrePosofGrid() ;
...
namespace Pb {
	void MantaEnsureRegistration()
	{
		...
		PbRegister_getCurl() ;
		PbRegister_setObsFromLevelset() ;
		PbRegister_clampRealGridFromLevelset() ;
		PbRegister_calcSecDeriv2d() ;
		PbRegister_totalSum() ;
		PbRegister_normalizeSumTo() ;
		PbRegister_cgSolveWE() ;
		PbRegister_centrePosofGrid() ;
