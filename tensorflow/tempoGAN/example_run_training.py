...
os.system('python tempoGAN.py collapse_z 0 saveInterval 200 randSeed 42 out 0 trainingIters 4000 lambda 5.0 lambda2 -0.00001 discRuns 2 genRuns 2 alwaysSave 1 fromSim 1006 toSim 1006 outputInterval 200 genValiImg 0 dataDim 2 batchSize 16 useVelocities 0 useVorticities 0 gif 0 genModel gen_resnet discModel disc_binclass basePath ../2ddata_gan/ loadPath ../2ddata_sim/ lambda_t 1.0 lambda_t_l2 0.0 frameMax 2400 data_fraction 0.05 adv_flag 0 dataAugmentation 0 rot 2 decayLR 1')
