...
os.system('python tempoGAN.py drawParticles 1 randSeed 42 out 1 trainingIters 200 lambda 5.0 lambda2 -0.00001 discRuns 2 genRuns 2 alwaysSave 1 fromSim 4444 toSim 4444 outputInterval 200 genValiImg 1 dataDim 2 batchSize 16 useVelocities 0 useVorticities 0 gif 0 genModel gen_resnet discModel disc_binclass basePath ../2ddata_gan/ loadPath ../2ddata_sim/ lambda_t 0.0 lambda_t_l2 0.0 frameMax 10 data_fraction 1.0 adv_flag 0 dataAugmentation 0 rot 2 decayLR 1 load_model_test 241 load_model_no 255 simSize 64 tileSize 64')
"""
#3D
