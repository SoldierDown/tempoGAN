...
batch_size = 64
density_prev = tf.constant(1./(batch_size**2), shape = [batch_size, batch_size])
density_after = tf.constant(1./(batch_size**2), shape = [batch_size, batch_size])	
loss = emd_loss(density_prev, density_after)
